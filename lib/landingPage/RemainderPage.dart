...
class _RemainderPageState extends State<RemainderPage> {
  ...
  acquireData(AddManuallyViewModel viewModel){
    ...
    widget.pill.startDate=viewModel.getDate(viewModel.dateController1.text.toString());
    widget.pill.endDate=viewModel.getDate(viewModel.dateController2.text.toString());
  }
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AddManuallyViewModel>.reactive(
      ...
      onModelReady: (viewModel){
        ...
        viewModel.dateController1.text=viewModel.reverseGetDate(widget.pill.startDate);
        viewModel.dateController2.text=viewModel.reverseGetDate(widget.pill.endDate);
        //viewModel.getUser();
